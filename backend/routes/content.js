...
const DEFAULTS = [
  ...
  { page:'product', section:'below_fold', field:'body4',   value:'Tablets often pass through your system before your body can use them. Bee Pearl delivers enzymes, amino acids, and vitamins in a form your gut recognizes — without the synthetic binders or fillers.' },
  { page:'product', section:'below_fold', field:'mv_p1',   value:'No synthetic binders, fillers, or lab-made isolates.' },
  { page:'product', section:'below_fold', field:'mv_p2',   value:'Pre-digested by bees — nutrients your body absorbs, not just passes through.' },
  { page:'product', section:'below_fold', field:'mv_p3',   value:'250+ bioactive compounds working together, not a handful of isolated vitamins.' },
  { page:'product', section:'below_fold', field:'mv_p4',   value:'Supports energy, immunity, recovery, and mental clarity from one whole-food source.' },
  ...
  { page:'product', section:'videos', field:'video1_url',   value:'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4' },
  ...
  { page:'product', section:'videos', field:'video2_url',   value:'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4' },
  ...
  { page:'product', section:'videos', field:'video3_url',   value:'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4' },
  ...
  { page:'product', section:'videos', field:'video4_url',   value:'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4' },
